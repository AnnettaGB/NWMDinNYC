...
public class AStar {
	...
	/**
	 * AStar Algorithm takes two network nodes and returns the shortest path
	 *   Note: the last index on the path is not the same location as the goal node 
	 *   Agents must be snapped to the goal node at the end of the path 
	 * @param start
	 * @param goal
	 * @return
	 */
    public ArrayList<GeomPlanarGraphDirectedEdge> astarPath(Node start, Node goal) {
        ...
        startNode.fx = startNode.hx; // Alex Freedman code contribution
